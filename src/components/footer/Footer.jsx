              ...
              <ul className="footer-list">
                <li className="footer-list-item">
                  <a
                    rel="noreferrer"
                    target="_blank"
                    href="https://github.com/ayezabashir"
                  >
                ...
                <li className="footer-list-item">
                  <a
                    rel="noreferrer"
                    target="_blank"
                    href="https://www.linkedin.com/in/ayezabashir"
                  >
                ...
                <li className="footer-list-item">
                  <a
                    rel="noreferrer"
                    target="_blank"
                    href="https://codepen.io/ayezabashir"
                  >
                ...
                <li className="footer-list-item">
                  <a
                    rel="noreferrer"
                    target="_blank"
                    href="https://discordapp.com/users/1323909159548358687"
                  >
                ...
                <li className="footer-list-item">
                  <a
                    rel="noreferrer"
                    target="_blank"
                    href="https://www.frontendmentor.io/profile/ayezabashir"
                  >
